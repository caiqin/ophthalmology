...
<@header title="疾病种类分类管理">  
</@header>


<body class="hold-transition skin-blue sidebar-mini">
<div class="wrapper">
	<@navigation title="疾病种类分类管理">  
	</@navigation>
			            ...
			            <div class="box-body">
			                <form id="formSearch" class="form-horizontal">
			                    <div class="form-group" style="margin-top:15px">
			                        <label class="control-label col-sm-2" for="typeName">种类名称</label>
			                        <div class="col-sm-3">
			                            <input type="text" class="form-control" id="typeName" placeholder="种类名称">
			                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">新增疾病种类</h4>
                </div>
                <div class="modal-body">
					<form id="addDiseaseType" class="form-horizontal"  method="post">
	                    <div class="form-group">
	                        <label for="diseaseTypeName" class="col-sm-2 control-label">分类名称</label>
	                        <div class="col-sm-10">
	                        	<input type="text" name="diseaseTypeName" class="form-control" id="catName" placeholder="分类名称">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label for="diseaseTypeDesc" class="col-sm-2 control-label">描述</label>
	                        <div class="col-sm-10">
	                        	<textarea name="diseaseTypeDesc" rows="3" class="form-control" id="diseaseTypeDesc" placeholder="描述"></textarea>
	                        </div>
	                    </div>
	                    <div class="form-group">
	...
	<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">修改疾病种类信息</h4>
                </div>
                <div class="modal-body">
					<form id="editDiseaseType" class="form-horizontal"  method="post">
	                   <div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                        	...
	                        	<input type="text" name="diseaseTypeName" class="form-control" id="diseaseTypeName" placeholder="分类名称">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label for="diseaseTypeDesc" class="col-sm-2 control-label">描述</label>
...
<script src="${BasePath}/res/bizmgt/js/basedata/diseasetype.js"></script>
